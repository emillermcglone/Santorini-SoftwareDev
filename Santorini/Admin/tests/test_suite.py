...
from test_board import test_cases as board_test_cases
...
if __name__ == "__main__":
    test_cases = direction_test_cases + height_test_cases + rules_test_cases + worker_test_cases + board_test_cases
