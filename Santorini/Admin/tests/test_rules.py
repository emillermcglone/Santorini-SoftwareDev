...
class TestInit(unittest.TestCase):
    ...
    def test_place_move_and_build_rules(self):
        rules = Rules(self.true_and_false, self.all_true, self.all_false)
        self.assertEqual(rules.place_rules, self.true_and_false)
...
class TestCheckPlace(unittest.TestCase):
    ...
    def test_true_with_all_true(self):
        rules = Rules(self.all_true, self.all_true, self.all_false)
        self.assertTrue(rules.check_place([[]], 1, Direction.N))
    
    def test_false_with_all_false(self):
        rules = Rules(self.all_false, self.all_false, self.all_true)
        self.assertFalse(rules.check_place([[]], 1, Direction.N))

    def test_false_with_true_and_false(self):
        rules = Rules(self.true_and_false, self.true_and_false, self.all_true)
        self.assertFalse(rules.check_place([[]], 1, Direction.N))
...
class TestCheckMove(unittest.TestCase):
    ...
    def test_true_with_all_true(self):
        rules = Rules(self.all_false, self.all_true, self.all_false)
    ...
    def test_false_with_true_and_false(self):
        rules = Rules(self.all_false, self.true_and_false, self.all_true)
        self.assertFalse(rules.check_move([[]], 1, Direction.N))
...
class TestCheckBuild(unittest.TestCase):
    ...
    def test_true_with_all_true(self):
        rules = Rules(self.all_true, self.all_false, self.all_true)
    ...
    def test_false_with_true_and_false(self):
        rules = Rules(self.all_true, self.all_true, self.true_and_false)
        self.assertFalse(rules.check_build([[]], 1, Direction.N))

test_cases = [TestInit, TestCheckPlace, TestCheckBuild, TestCheckMove]
